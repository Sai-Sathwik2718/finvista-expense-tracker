...
import { PieChart, Lock, Mail, User, AlertCircle } from 'lucide-react';
    ...
    <div style={{
      ...
      <div className="aurax-card" style={{ width: '100%', maxWidth: '440px', padding: '2.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '1.6rem', color: 'var(--text-primary)', margin: 0 }}>Join FinVista</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '0.35rem' }}>Start tracking with intelligent budget alerts</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" disabled={loading} className="btn btn-primary" style={{ width: '100%', padding: '0.8rem' }}>
            {loading ? 'Creating workspace...' : 'Create FinVista Workspace'}
          </button>
        </form>
